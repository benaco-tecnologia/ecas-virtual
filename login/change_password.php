<?PHP // $Id: change_password.php,v 1.62.2.4 2011/11/15 11:30:59 moodlerobot Exp $
    ...
    if ($mform->is_cancelled()) {
		...
		// Cambiamos password en alumnos.ecas.cl
		// password cambiado, se genera cambio en portal alumnos
		$nombreUsuario = $USER->username;
		$nuevaClave = $data->newpassword1;
		$parametros = "?nombreUsuario=$nombreUsuario&nuevaClave=$nuevaClave";
		$portal_alumnos = @file_get_contents($CFG->cambiopaswordalumnos . $parametros);
		//die($portal_alumnos);
