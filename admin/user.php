<?php // $Id: user.php,v 1.109.2.4 2008/07/10 08:36:02 skodak Exp $
    ...
    $columns = array("firstname", "lastname", "email", "city", "country", "lastaccess", "tipo_usuario");
    ...
    if (!$users) {
        ...
        $table->head = array ($fullnamedisplay, $email, $lastaccess, "Tipo", "", "", "");
	...
	print_heading("No se muestran usuarios que nunca han ingresado a EcasVirtual (Último acceso = NUNCA).");
