...
if (!is_numeric(get_field('user', 'username', 'id', $USER->id))) { 
	$this->content->text .= '<div class="depth0"><a class="link" href="http://alumnos.ecas.cl/certificados/admin/?usrcod=admin" onclick="certificados(this.href); return false;"><img src="http://www.ecasvirtual.cl/pix/i/item.gif" alt="">Certificados</a></div>';
}

//if (!is_numeric(get_field('user', 'username', 'id', $USER->id))) { 
	$this->content->text .= '<div class="depth0"><a class="link" href="http://alumnos.ecas.cl/desarrollo/reiniciar-clave.asp" onclick="certificados(this.href); return false;"><img src="http://www.ecasvirtual.cl/pix/i/item.gif" alt="">Reiniciar Clave</a></div>';
//}
